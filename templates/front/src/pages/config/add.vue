	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" v-else label="值" prop="value">
				<img v-if="ruleForm.value.substring(0,4)=='http'" class="upload-img" :key="index" :src="ruleForm.value.split(',')[0]">
				<img v-else class="upload-img" :key="index" v-for="(item,index) in ruleForm.value.split(',')" :src="baseUrl+item">
			</el-form-item>
