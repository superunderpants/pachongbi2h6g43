	...
	<div>
		<div class="breadcrumb-preview">
			<el-breadcrumb :separator="'→'">
				...
				<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" :to="'/index/zixunfenlei?centerType=' + (centerType?'1':'0')"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('zixunfenlei','修改')" @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('zixunfenlei','删除')" @click="delClick">删除</el-button>
						<el-button class="editBtn" @click="allchapterClick()" type="warning" v-if="btnAuth('zixunfenlei','章节管理')">章节管理</el-button>
					</div>
				</div>
			</div>
		...
		methods: {
			...
			backClick(){
				if(this.storeupType){
					...
					this.$router.push({path: '/index/zixunfenlei', query: params});
				}
			},
			// 下载
			download(file ){
			...
			allchapterClick (){
				...
				this.$router.push({path: '/index/chapterzixunfenlei', query: params});
			},
			// 获取uuid
			getUUID() {
