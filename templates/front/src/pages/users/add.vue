	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" v-else label="头像" prop="image">
				<img v-if="ruleForm.image.substring(0,4)=='http'" class="upload-img" :key="index" :src="ruleForm.image.split(',')[0]">
				<img v-else class="upload-img" :key="index" v-for="(item,index) in ruleForm.image.split(',')" :src="baseUrl+item">
			</el-form-item>
