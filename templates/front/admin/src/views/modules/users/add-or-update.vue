		...
		>
			<template >
				...
				<el-form-item class="upload" v-else-if="ruleForm.image" label="头像" prop="image" >
					<img v-if="ruleForm.image.substring(0,4)=='http'&&ruleForm.image.split(',w').length>1" class="upload-img" style="margin-right:20px;" :key="index" :src="ruleForm.image" width="100" height="100" @click="imgPreView(ruleForm.tupian)">
					<img v-else-if="ruleForm.image.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" :key="index" :src="ruleForm.image.split(',')[0]" width="100" height="100" @click="imgPreView(ruleForm.tupian.split(',')[0])">
					<img v-else class="upload-img" style="margin-right:20px;" :key="index" v-for="(item,index) in ruleForm.image.split(',')" :src="$base.url+item" width="100" height="100" @click="imgPreView($base.url+item)">
				</el-form-item>
			</template>
