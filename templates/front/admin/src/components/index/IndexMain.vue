<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 140px","margin":"0","position":"relative","background":"#fafafe","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 250px","position":"relative","background":"#F9FAFB","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0px 530px 0 0","boxShadow":"0px 3px 10px 1px rgba(0,0,0,0.05)","margin":"0 auto","alignItems":"center","background":"#fff","display":"flex","width":"calc(100% - 250px)","position":"fixed","justifyContent":"flex-end","zIndex":"1002","height":"84px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"calc(100% - 60px)","padding":"114px 10px 10px 0px","boxShadow":"0 0px 0px #055bab","margin":"0 auto","borderRadius":"0px","background":"none"}' class="bread-crumbs"></bread-crumbs>
