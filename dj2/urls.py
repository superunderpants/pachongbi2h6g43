...
urlpatterns = [
    ...
    re_path(r'{}/css/(?P<p1>.*?)/?$'.format(schemaName), views.css1),
    re_path(r'{}/js/(?P<p1>.*?)/?$'.format(schemaName), views.js1),
    re_path(r'{}/img/(?P<p1>.*?)/?$'.format(schemaName), views.img1),
    re_path(r'{}/verifys/(?P<p1>.*?)/?$'.format(schemaName), views.verifys1),
    re_path(r'{}/vendor.dll.js/?$'.format(schemaName), views.schema_front1, {'p1': 'vendor.dll.js'}),
    re_path(r'{}/admin/(?P<p1>.+?)/?$'.format(schemaName), views.admin_file1),
    re_path(r'{}/admin/(?P<p1>.+?)/(?P<p2>.+?)/?$'.format(schemaName), views.admin_file2),
    re_path(r'{}/admin/(?P<p1>.+?)/(?P<p2>.+?)/(?P<p3>.+?)/?$'.format(schemaName), views.admin_file3),
    re_path(r'{}/admin/(?P<p1>.+?)/(?P<p2>.+?)/(?P<p3>.+?)/(?P<p4>.+?)/?$'.format(schemaName), views.admin_file4),
    ...
    re_path(r'verifys/(?P<p1>.*?)/?$', views.verifys1),
    re_path(r'vendor.dll.js/?$', views.schema_front1, {'p1': 'vendor.dll.js'}),
